    ...
    <div class="container">
       ...
       ?>
        ...
        <nav class="nav nav-pills flex-column flex-sm-row">
            ...
            <a class="flex-sm-fill text-sm-center nav-link" href="usuario.php" target="link">Cadastro de Usuarios</a>
            <a class="flex-sm-fill text-sm-center nav-link" href="#" target="link">Usuários</a>
